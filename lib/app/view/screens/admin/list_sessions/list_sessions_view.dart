                  ...
                  child: Consumer<ListSessionsProvider>(
                      ...
                      itemBuilder: (_,index){
                        return Container(
                          ...
                          child: ListTile(
                            leading: Text(value.sessions.sessions[index].name/*sessions![index].name*/),
                            subtitle: Text("${DateFormat().add_yMd().add_jm().format(value.sessions.sessions[index].date)}"),
                            trailing: InkWell(
                                onTap: (){
                                  Get.defaultDialog(
                                    confirm: Row(
                                      children: [
                                        TextButton(
                                            ...
                                            onPressed: () async {
                                              ...
                                              final result =await value.deleteSession(context, idSession: value.sessions.sessions[index].id);
                                              Navigator.of(context).pop();
                                              if(result['status']){
                                                value.sessions.sessions.removeAt(index);
